...
- **WHEN** V001–V005 MUST be applied in order to each of two independent empty MySQL 8.0 databases
- **THEN** both yield identical table/index definitions; rerunning in the same database is not required.
