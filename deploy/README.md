...
| `nginx/default.conf` | 8080 SPA fallback, `/api` → `http://api:8080/` prefix-strip proxy, security headers, body limit/timeouts, upstream header hiding | authored, CSP not browser-validated |
