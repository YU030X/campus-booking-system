...
| `demo/contract-tests.ps1` | offline Plan/refusal plus profile/secret/journal/transactional-compensation/teardown/evidence contract suite; no Docker/SQL/HTTP/E2E/browser | PASS: 119 assertions; no real Demo |
